...
import com.jiggycode.util.FindAuthenticatedUser;
...
public class UserServiceImpl implements UserService {
    ...
    public void updatePassword(PasswordUpdateRequest passwordUpdateRequest) {
        ...
        if (!isNewPasswordConfirmed(passwordUpdateRequest.getNewPassword(), passwordUpdateRequest.getConfirmedNewPassword())) {
